...
public class fmGUI extends JFrame {
    ...
    private JPanel crearFormularioJugador() {
        ...
        btnAccionJugador.addActionListener(e -> accionJugador());
    ...
    private void configurarTablaJugadores(JTable tabla) {
        ...
        editarItem.addActionListener(e -> editarJugadorSeleccionado());
        eliminarItem.addActionListener(e -> eliminarJugadorSeleccionado());
